...
export type RewardTable = Readonly<Record<number, ReadonlyArray<RewardDefinition>>>;

export const CLASS_REWARDS: Readonly<Record<ClassId, RewardTable>> = {
  [ClassId.Adventurer]: {
...
export const CLASSLESS_RECURRING_REWARD: ReadonlyArray<RewardDefinition> = [
  { itemId: "minecraft:bread", amount: 16 },
  { itemId: "minecraft:torch", amount: 32 },
  { itemId: "minecraft:experience_bottle", amount: 4 }
];

export const QUEST_REWARDS: Readonly<Record<string, ReadonlyArray<RewardDefinition>>> = {
